...
Il problema che ci si \`e posti di risolvere poteva essere risolto in modo deterministico ma per lo scopo del progetto (.. si volle (?)) risolvere il problema tramite un'algoritmo di ML, per poter testare (.. l'accuratezza e l'efficenza nella generalizzazione).
