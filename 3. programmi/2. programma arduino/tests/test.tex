  ...
  unsigned char b[4];
	...
	\begin{lrbox}{\mytikzboxone}%
		\begin{minipage}{.50\linewidth}%
			...
			\node at (0,0) (A) {};
	        \node [anchor=south, rect, outer sep=0pt] at (A.south) (B) {};
	        \node [anchor=south, rect, outer sep=0pt] at (B.south) (C) {1};
	        \node [anchor=south, rect, outer sep=0pt] at (C.south) (D) {2};
	        \node [anchor=south, rect, outer sep=0pt] at (D.south) (E) {3};
	        \node [anchor=south, rect, outer sep=0pt] at (E.south) (F) {};
	        \node [anchor=south, rect, outer sep=0pt] at (F.south) (G) {};
			\end{tikzpicture}%
		\end{minipage}%
	\end{lrbox}%
